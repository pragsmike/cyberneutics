# Comparison Runs: Deliberative vs. CJT-Style (original README)

**Provenance**: This file is the original `agent/comparisons/README.md`, preserved here after the comparison runs were moved into the condorcet-comparison research program.
...
- **01-deliberative-summary.md** — Pointer to and summary of deliberative run (resolution, votes).
