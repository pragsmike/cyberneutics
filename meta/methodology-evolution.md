...
- **Organ vs. bloodstream**: two regimes with different type-theoretic properties. Inside an organ, types are assigned by construction; in the bloodstream, types are claims requiring evaluation. This resolves a tension in the formalism.
...
- Description logic (TBox/ABox/reasoner) maps to the bloodstream model; fuzzy DL needed for graded soft-type membership
...
- Narrative immune systems work extends the formalism toward open-world (bloodstream) settings
