...
Five independent agents — each with a genuinely different worldview — examine your situation, argue with each other, and produce a map of the decision space. The output is not "the answer." It's a clear picture of what's at stake, what's uncertain, and what different framings reveal.

## What you'll get

- Five distinct opening positions on your problem
- A structured cross-examination where the agents challenge each other
...
Each agent runs independently — they don't see each other's work until the cross-examination phase.
...
Before invoking any agents, the orchestrator drafts a one-paragraph charter: restating the topic as a genuine question, identifying what kind of uncertainty is present, and naming what a good deliberation would produce.

### STAGE 2 — Independent positions (all five agents, in parallel)

Each agent receives:
- The original topic/question
- The charter from Stage 1
- Instruction: produce your opening position independently, without seeing other agents' views

All five positions are collected before proceeding.

### STAGE 3 — Cross-examination (each agent sees all positions)
...
This is where the real value emerges. Agents challenge each other directly. Polite agreement is a failure mode — the agents are designed to argue.
...
- **Irresolvable tensions** — where the agents disagree and the disagreement reflects a real trade-off, not a misunderstanding
...
- [Assumption 1]: Which agent identified this
...
**DECISION SPACE MAP:**
Not "do this" but "if you optimize for X, you sacrifice Y, and here's what each agent thinks matters most"
...
**Traceability**: Every claim in the synthesis traces back to a specific agent's position. You can always ask "who said that and why?"

**Disagreement is the signal**: If all five agents agree easily, something is being swept under the rug. The value is in the tension between perspectives, not in consensus.
