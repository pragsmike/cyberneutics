...
*   ~~**Incorporate diary/2026-02-21-cyberneutics-dual-operations** and **wild/residuality-theory** into methodology, documents and palgebra formalism, and string diagram generation.~~: Theory documented — `palgebra/duality-and-composition.md` (formal treatment: fan/funnel duality, decision monad, iteration, new types, open questions) and `essays/10-decisions-under-uncertainty.md` (philosophical bridge). Cross-references updated in README.md, essays/README.md, palgebra/reference.md, wild/residuality-theory/README.md. **Remaining**: implement `/scenarios` skill (Phase 3), design scenario roster, compose fan→funnel as executable pipeline (Phase 4), implement `/probe` skill (Phase 5). String diagram generation update pending: fan/funnel spider rendering.