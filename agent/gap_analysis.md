...
Note: `research-programs/` directory was moved from `meta/research-programs/` to top-level. All references have been updated.
...
*   ~~**Extract project plan from `societies-of-thought-synthesis.md`**~~: Done — extracted to `research-programs/societies-of-thought-research-plan.md`; essay now has a bridging paragraph referencing the plan.
