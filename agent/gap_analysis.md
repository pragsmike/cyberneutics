...
*   ~~**Extract project plan from `societies-of-thought-synthesis.md`**~~: Done — extracted to `meta/research-programs/societies-of-thought-research-plan.md`; essay now has a bridging paragraph referencing the plan.
