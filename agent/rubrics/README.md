...
|--------|---------|--------|
| [repo-audience-experience.md](repo-audience-experience.md) | Score repository contents for how well they meet audience needs and how delightful the reader experience is (0–3 per dimension). | [agent/prompts/editorial-review.md](../prompts/editorial-review.md) — editorial review produces scores and a remediation plan to raise them. |
