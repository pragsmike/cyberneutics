...
| `research-programs/evaluation-schemes.md` | Experimental designs for committee vs. simpler methods; plan awaiting go-ahead. |
| `research-programs/multi-model-committee.md` | Multi-model committee investigation; plan awaiting go-ahead. |
