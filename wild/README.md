...
> **March 2026 Status Update**: All directories have been assessed in the WS-5 triage audit. See [wild triage report](../agent/archive/wild-triage-2026-03.md) for detailed status, graduation readiness, and promotion/shelving recommendations. Status indicators are shown below.
...
- **[Residuality Theory](residuality-theory/)** — *ACTIVE* — Barry O'Reilly's architecture philosophy (residues, architectural walks, criticality over correctness) mapped onto the cyberneutics pipeline. Reopened April 2026 after assimilating the full residuality corpus (six papers archived locally) and writing a survey, a union bibliography, a bilateral relationship note, a fan-as-stressor-generator working note, and a Deleuzian-grammar (assemblage/rhizome/nomad) reading. Essay-13 is the planned graduation target with multiple primary philosophical anchors: Serres and Latour load-bearing for the 2021 *Philosophy* paper, Deleuze load-bearing for the 2023 *Residuality and Representation* paper, Stacey underwriting both. The VSM critique remains to be answered explicitly in essay-13. See `wild/residuality-theory/README.md` for the directory's full state.
### Adjacent Domains
...
- **[Subagent Personas for Debate](archive/subagent-personas-for-debate/)** — Prior art for multi-persona LLM deliberation (superseded; content absorbed into research-programs).
