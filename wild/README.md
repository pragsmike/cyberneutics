...
- **[Residuality Theory](residuality-theory/)** — *ACTIVE* — Barry O'Reilly's architecture philosophy (residues, architectural walks, criticality over correctness) mapped onto the cyberneutics pipeline. Reopened April 2026 after reading the 2021 philosophy paper in full; essay-13 is the current graduation target (Serres-and-Latour as primary anchors, Stacey on causalities of certainty, Deleuze as pattern-match only, VSM critique answered).
### Adjacent Domains
