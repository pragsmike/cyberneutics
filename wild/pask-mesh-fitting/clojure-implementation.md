...
| **1 (Failing)** | Misunderstands the fundamental bloodstream/corpus distinction. Proposes using an LLM to simply "evaluate if the document is true" rather than extracting and comparing structural metadata. |
