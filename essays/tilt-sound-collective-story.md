# Tilt Sound Collective
## A Story About AI, Trust, and Games Within Games

*Five people take over a post-production studio and figure out, under pressure, how to use AI without being used by it. For the analytical framework this story dramatizes — the threat landscape, the hypervigilance problem, and the game-theoretic frame — see [The Stochastic Imps of Happenstance](./the-stochastic-imps-of-happenstance.md).*
...
**The analytical framework**: [The Stochastic Imps of Happenstance](./the-stochastic-imps-of-happenstance.md) — the threat landscape, hypervigilance problem, and game-theoretic frame this story dramatizes  
**The committee characters**: [Character Propensity Reference](../artifacts/character-propensity-reference.md) — operational manual for Maya, Frankie, Joe, Vic, and Tammy  
**The technique**: [Adversarial Committees](../artifacts/adversarial-committees.md) — how to run the committee in practice
