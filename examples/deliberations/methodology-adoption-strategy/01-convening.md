# Convening: Methodology Adoption Strategy (Scenario-Aware)
...
- **Joe × Tammy**: Joe will draw on what happened to other academic-turned-practical methodologies. Tammy will trace how the strategy choice creates feedback loops (e.g., writing more essays reduces time for outreach, which reduces uptake, which reduces motivation to write).
- **Vic × all**: Vic will demand evidence for claims about which strategy produces adoption. Most evidence is speculative at this stage — Vic's job is to surface what we'd need to observe to know which scenario is materializing.
